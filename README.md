...
# Glossary
 ...
 - Tickets - Individual user transactions (so "Borrowing Ticket" instead
   of "Borrowing request", because that's just confusing). internal use
   only.
 ...
 - Admin - A User with additional responsibilities of hosting a node,
   ...
   additional features from developers.# NeighborGoods NeighborGoods is
   a Federated Library of Things.
...
Community members willing to share items and skills, 
Community organizers planning local events, 
And Neighborhood administrators managing community engagement.
